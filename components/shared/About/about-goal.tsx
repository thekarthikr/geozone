    ...
    <div >
        ...
        <section className="mx-auto container">
          <div className="px-4 lg:px-0">
           ...
           <div  aria-label="group of cards" className="focus:outline-none px-4 py-3  gradient-red mt-12 rounded-md lg:px-0">
            <div className="mx-auto container flex flex-wrap px-2 lg:px-24">
           
           {
            slice.items[0] && (
<div  aria-label="card 1" className="focus:outline-none flex sm:w-full md:w-1/2 lg:border-r md:border-r sm:border-r-0 border-red-400 border-opacity-50 pb-10 lg:pt-10">
